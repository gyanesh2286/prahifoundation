<div class="printDoc">
    <div style="background:url('../../../img/card_logo.jpg');width: 504px; padding: 2px; margin: 0 auto;  border-radius: 5px;position: relative;height: 300px;background-repeat: no-repeat;background-size: 500px 350px;">
            ...
            <table width="500" cellspacing="0">
                ...
                <tr class="text-left">
                    ...
                    <td style="padding:10px 0px 10px 5px;width: 30%;text-align: center;">
                        <span style="color: #0055AD;">Regd. No </span><span style="color: #0055AD;font-weight: bold;">{{'2000000'.$user->id}} </span><br><br><br>
